...
export const routes: Routes = [
  {
    ...
    data: {
      title: 'Wilson Oliveira | Home', description: 'Bem-vindo ao meu portfólio.',
      animation: 'HomePage'
    }
  },
  {
    ...
    data: {
      title: 'Wilson Oliveira | Projetos', description: 'Confira meus projetos Full Stack.',
      animation: 'ProjPage'
    }
  },
  {
    ...
    data: {
      title: 'Wilson Oliveira | Sobre', description: 'Confira mais informacoes sobre mim.',
      animation: 'SobrePage'
    }
  },
  {
    ...
    data: {
      title: 'Wilson Oliveira | Contato', description: 'Confira mais informacoes de contato.',
